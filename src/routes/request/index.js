...
export default class RequestPage extends React.Component {
  ...
  render () {
    ...
    const { result, currntRequest, Filetree } = this.state
              ...
              <Col span={11} className={styles.tree}>
                ...
                >
                  <TreeNode title="Model Name" key="0-0">
                    <TreeNode title="model" key="0-0-0">
                      <TreeNode title="exe" key="0-0-0-0" />
                      <TreeNode title="others" key="0-0-0-1" />
                    </TreeNode>
                    <TreeNode title="supportive" key="0-0-1">
                      <TreeNode title="others" key="0-0-1-0" />
                    </TreeNode>
                    <TreeNode title="testify" key="0-0-2">
                      <TreeNode title="demoData" key="0-0-2-0" />
                      <TreeNode title="others" key="0-0-2-1" />
                    </TreeNode>
                    <TreeNode title="licence.txt" key="0-0-3" />
                    <TreeNode title="package.config" key="0-0-4" />
                  </TreeNode>
                </Tree>
              </Col>
            </Card>
